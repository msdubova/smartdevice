...
controlModal(); // маска для телефона
...
maskPhone(); // функция которая отслеживает размер вьюпорта чтоб запустиьт функции на опрелеленный вьюпорт
...
function setAccordeon() {
  ...
  var _loop = function _loop(_i) {
    buttons[_i].addEventListener('click', function () {
      ...
      accordeons[_i].classList.toggle('accordeon__block--closed'); // console.log(accordeons);
...
;
setResize(setAccordeon); // подробнее о нас
...
;
setTextAccordeon(); //  function readMoreDesktop ()
//  {

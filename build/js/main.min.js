...
function controlModal() {
  ...
  var submit = modal.querySelector('.modal__button'); // Функция отслеживает клавишу ESCape в режиме открытого модально окна, и закроет его в случае нажатия отслеживаемой клавиши
